...
all_structures = [f"MFI_BA{i}.cif" for i in range(1, 5)]
...
for structure in all_structures: # iterate through all structures and perform vasp calc
    perform_bootstrap(struc_path=structure, files_to_copy=files_to_copy, bootstrap=bootstrap)